!(function (e, t) {
	...
	return (function (e) {
		...
		function (e, t) {
			...
			function u() {
				h && d && ((h = !1), d.length ? (m = d.concat(m)) : (y = -1), m.length && a());
			}
			function a() {
				if (!h) {
					var e = o(u);
					...
					function t() {
						...
						return (
							(e.getVideoElement = function (t, fs) {
								var r = e.props.InformationElement ? e.props.InformationElement : m.DefaultInfoElement,
									o = [d.default.imageWrapper],
									dc = e.props.cardColumn > 2 ? ' player-sm' : ' player-bg';
								// videoReact = require("video-react")
								// 영상을 이미지로 바꾸느라 주석처리
								// if (e.props.cardColumn >= 3) {
								//   cn = "player-sm"
								// }
								return s.default.createElement(
									...
									{
										className: o.join(' ') + dc,
										onClick: e.pinchInFlag || e.pinchOutFlag ? null : e.image_clickHandler(t, fs),
										key: `video_${fs}`,
									},
							...
							(e.lightBox_clickHandler = function (t) {
								...
								t.targetClassName !== d.default.lightbox && e.props.changeOptionsPinch(true);
							}),
									...
									return s.default.createElement(
										'div',
										{
											...
											style: {
												...
												height: Math.ceil(contents.length / cardColumn) * ((cw / cardColumn) * 0.562 + 3) + 'px',
											},
										},
								...
								value: function () {
									...
									return t.map(function (t, o) {
										return s.default.createElement(
											...
											t.feedContentInfo.contentAttribute === 'VIDEO' ? e.getVideoElement(t.feedContentInfo, t.feedSeq) : e.getImageElement(t.feedContentInfo, t.feedSeq)
										);
									});
								},
							},
				...
				e.exports = function (e, n) {
						...
						function r(r, l, s, p, d, m, h) {
							...
							return null == l[s]
								? r
									? new f(
											null === l[s]
												? 'The ' + d + ' `' + m + '` is marked as required in `' + p + '`, but its value is `null`.'
												: 'The ' + d + ' `' + m + '` is marked as required in `' + p + '`, but its value is `undefined`.'
									  )
									: null
								: e(l, s, p, d, m);
						}
					...
					function p(e) {
						function t(t, n, r, o, i, u) {
							var a = t[n];
							if (E(a) !== e) return new f('Invalid ' + o + ' `' + i + '` of type `' + x(a) + '` supplied to `' + r + '`, expected `' + e + '`.');
							return null;
						}
						return s(t);
					}
					...
					function m(e) {
						function t(t, n, r, o, i) {
							if (!(t[n] instanceof e)) {
								var u = e.name || P;
								return new f('Invalid ' + o + ' `' + i + '` of type `' + I(t[n]) + '` supplied to `' + r + '`, expected instance of `' + u + '`.');
							}
							return null;
						}
						return s(t);
					...
					function h(e) {
						function n(t, n, r, o, i) {
							for (var u = t[n], a = 0; a < e.length; a++) if (l(u, e[a])) return null;
							return new f('Invalid ' + o + ' `' + i + '` of value `' + u + '` supplied to `' + r + '`, expected one of ' + JSON.stringify(e) + '.');
						}
						return Array.isArray(e) ? s(n) : ('production' !== t.env.NODE_ENV && i(!1, 'Invalid argument supplied to oneOf, expected an instance of array.'), r.thatReturnsNull);
					}
					function y(e) {
						function t(t, n, r, o, i) {
					...
					function g(e) {
						...
						for (var o = 0; o < e.length; o++) {
							var a = e[o];
							if ('function' != typeof a) return i(!1, 'Invalid argument supplid to oneOfType. Expected an array of check functions, but received %s at index %s.', w(a), o), r.thatReturnsNull;
						}
						return s(n);
					}
					function v(e) {
						...
						S = {
							...
							element: (function () {
								function t(t, n, r, o, i) {
									var u = t[n];
									if (!e(u)) {
										return new f('Invalid ' + o + ' `' + i + '` of type `' + E(u) + '` supplied to `' + r + '`, expected a single ReactElement.');
									}
									return null;
								}
								return s(t);
							...
							node: (function () {
								function e(e, t, n, r, o) {
									return b(e[t]) ? null : new f('Invalid ' + r + ' `' + o + '` supplied to `' + n + '`, expected a ReactNode.');
								}
								return s(e);
							})(),
							objectOf: y,
					...
					return (f.prototype = Error.prototype), (S.checkPropTypes = a), (S.PropTypes = S), S;
				};
			}.call(t, n(0)));
		},
		function (e, t, n) {
					...
					if ('production' !== t.env.NODE_ENV)
						for (var f in e)
							if (e.hasOwnProperty(f)) {
								var s;
								try {
									o('function' == typeof e[f], '%s: %s type `%s` is invalid; it must be a function, usually from React.PropTypes.', c || 'React class', r, f), (s = e[f](n, f, c, r, null, u));
								} catch (e) {
									s = e;
								}
								if (
									...
									a[s.message] = !0;
									var p = l ? l() : '';
									i(!1, 'Failed %s type: %s%s', r, s.message, null != p ? p : '');
								}
							}
				}
				if ('production' !== t.env.NODE_ENV)
		...
		function (e, t, n) {
			...
			Object.defineProperty(t, '__esModule', { value: !0 }), (t.DefaultInfoElement = void 0);
			var o = n(5),
				i = r(o),
				u = n(15),
				a = r(u);
			t.DefaultInfoElement = function (e) {
				...
				return i.default.createElement(
					...
					i.default.createElement('p', null, i.default.createElement('a', { href: t.link }, t.link)),
