					...
					function t() {
						...
						return (
							(e.getVideoElement = function (t, n) {
								...
								if (e.props.cardWidthIndex > 2) {
									cn = 'player-sm';
								} else if (e.props.cardWidthIndex === 2) {
									cn = 'player-md';
								} else {
									cn = 'player-bg';
								}
								...
								value: function () {
									var e = this,
										...
										r = {
											...
											height: this.props.getContentHeight() + 'px',
									...
									return t.map(function (t, o) {
										return s.default.createElement(
											...
											t.feedContentInfoList[0].contentAttribute === 'VIDEO' ? e.getVideoElement(t.feedContentInfoList[0], t.feedSeq) : e.getImageElement(t.feedContentInfoList[0], t.feedSeq)
										);
									});
								},
							},
...
>>>>>>> 414a58fbca591f5b3df651b7ad77691d911b439e
